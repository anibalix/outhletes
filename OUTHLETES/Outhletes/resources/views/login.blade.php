...
<!-- NAV BAR -->
            <nav class="nav_bar_top">
                <ul class="ul_nav_bar">
                    <li><a href="index"><img src="imagenes/logoSquereOuthletesWHITE.png" alt="" id="logo"/></a></li>
                    <li><a href="index"><img src="imagenes/logoOuthletesWHITE.png" alt="" id="logo_full"/></li>
